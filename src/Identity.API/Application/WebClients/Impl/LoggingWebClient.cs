...
namespace Sofisoft.Accounts.Identity.API.Application.WebClients
{
    public class LoggingWebClient : ILoggingWebClient
    {
        private IOptions<IdentitySetting> _settings;

        public LoggingWebClient(IOptions<IdentitySetting> settings)
        {
